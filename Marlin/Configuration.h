...
#define STRING_CONFIG_H_AUTHOR "(KaiNet-X, default config)" // Who made the changes.
 ...
 */
#define MAX_BED_POWER 96 // limits duty cycle to bed; 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2520, 2520 }
